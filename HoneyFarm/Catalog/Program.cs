...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "HoneyFarm- Catalog HTTP API",
        Version = "v1",
...
builder.Services.AddTransient<ICatalogContainerRepository, CatalogContainerRepository>();
builder.Services.AddTransient<ICatalogTypeRepository, CatalogTypeRepository>();
builder.Services.AddTransient<ICatalogService, CatalogService>();
builder.Services.AddTransient<ICatalogItemService, CatalogItemService>();
builder.Services.AddTransient<ICatalogContainerService, CatalogContainerService>();
